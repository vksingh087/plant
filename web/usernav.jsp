	   ...
	   <div id="menu" class="navbar-collapse collapse">
	     <ul class="nav navbar-nav">
		    ...
		    <li class="nav-item"><a href="#" class="nav-link">About Us</a></li>
                    ...
                    <li class="nav-item"><a href="user.jsp?msg=success" class="nav-link" style="color:white" data-toggle="modal" data-target="#chatbox">Chat</a></li>
                    <li class="nav-item"><a href="#" class="nav-link" style="color:white">Orders</a></li>
